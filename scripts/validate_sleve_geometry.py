...
def main() -> int:
    ...
    parser.add_argument("--height-lowest-level", type=float, default=20.0)
    ...
    parser.add_argument("--smooth-cycles", type=int, default=10)
    parser.add_argument("--minimum-mass-jacobian", type=float, default=0.0)
    parser.add_argument("--minimum-interface-thickness", type=float, default=12.0)
